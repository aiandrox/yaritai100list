 ...
 * **仕様を変えたらここも直す。**
 *
 * ⚠️ **免責（第7条）は「一切の責任を負わない」で書いてある**（2026-09-01 の利用者の判断）。
 * 消費者契約法8条により、**この条項がそのまま有効になるとは限らない**
  ...
  return (
    <LegalPage title="利用規約">
      ...
      <LegalList>
        ...
        <li>
          運営者は、本サービスを提供・維持するために必要な範囲で、投稿内容を保存・表示します。
        </li>
        <li>
          公開範囲は利用者が選べます。
          <strong className="font-bold text-slate-900">
      ...
      <LegalList>
        ...
        <li>
          <strong className="font-bold text-slate-900">
            本サービスの利用によって生じたいかなる損害についても、運営者は一切の責任を負いません。
          </strong>
        </li>
