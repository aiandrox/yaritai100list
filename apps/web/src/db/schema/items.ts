 ...
 * やりたいこと1件。
 *
 * 🔴 **取り入れ元（#10）をこの表の列にしない**（2026-08-07 利用者の判断）。
 * 取り入れは本文をコピーする操作で、**コピー後に本文を書き換えたら関係は切れる。**
 * 列で持つと「本文を変えたら NULL に戻す」という後始末がここに紛れ込むし、
 * **nullable な外部キー**が1本増える。取り入れの関係だけを持つ別の表にする。
 * 詳細は `TECH_STACK.md` §12 とイシュー #10 のコメント。
 *
