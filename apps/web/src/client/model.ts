  ...
  return [
    {
      ...
      title: 'リストが消えない',
      without:
        '現在書いているリストは、このブラウザにしか存在しないため、ブラウザの履歴を消すとデータがなくなります',
      with: 'サーバーに保存されます。別の端末でもリストを編集できるようになります',
    },
    {
      title: '「やった」印を付けられる',
      without: 'チェックを付けられません',
      with: 'やった項目にチェックを付けられるようになります',
    },
    {
      title: `リストを${String(LISTS_PER_USER_MAX)}つまで持てる`,
      without: '現在は1つしかリストを編集できません',
      with: `「${String(now.getFullYear())}年に」「一生のうちに」のように使い分けられます`,
    },
    {
      title: '人に見せられる',
      without: '見せられません',
      with: '共有リンクを発行して、他の人にやりたいことリストを見せることができます',
    },
    {
      title: '画像で保存できる',
      without: '保存できません',
      with: 'やりたいことリストの画像をダウンロードできます。SNS などに貼ることができます',
    },
  ]
}
